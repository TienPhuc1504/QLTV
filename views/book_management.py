...
class BookManagement(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Category filter
        ctk.CTkLabel(search_frame, text="Thể loại:").pack(side="left", padx=(20, 5))
        ...
        self.category_combo = ctk.CTkComboBox(
            ...
            command=lambda e: self.search_books(),
            width=150
        )
        ...
        self.tree.heading("tieu_de", text="Tiêu đề")
        self.tree.heading("tac_gia", text="Tác giả")
        self.tree.heading("the_loai", text="Thể loại")
        self.tree.heading("loai_sach", text="Loại sách")
    ...
    def load_books(self):
        ...
        for book in books:
            ...
            trang_thai = trang_thai_map.get(book['trang_thai_sach'], book['trang_thai_sach'])
...
class BookDialog(ctk.CTkToplevel):
    ...
    def create_widgets(self):
        ...
        ctk.CTkRadioButton(type_frame, text="Sách giấy", variable=self.type_var, 
                          value="SACH_GIAY", command=self.on_type_change).pack(side="left", padx=10)
        ctk.CTkRadioButton(type_frame, text="Sách online", variable=self.type_var, 
                          value="SACH_ONLINE", command=self.on_type_change).pack(side="left", padx=10)
        
        # Frame cho sách giấy
        self.paper_frame = ctk.CTkFrame(frame, fg_color="transparent")
        self.paper_frame.pack(fill="x")
        
        ctk.CTkLabel(self.paper_frame, text="Số lượng:", anchor="w").pack(fill="x", pady=(0, 5))
